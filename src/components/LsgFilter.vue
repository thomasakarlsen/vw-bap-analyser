...
const availableFilters = ref(props.fileMeta.lsgIds);

watch(() => props.fileMeta.lsgIds, () => {
  availableFilters.value = props.fileMeta.lsgIds;
}, { deep: true });
...
<template>
  <div class="flex items-center gap-2">
    <label for="channel-filter-search" class="text-xl font-semibold">LSG IDs</label>
